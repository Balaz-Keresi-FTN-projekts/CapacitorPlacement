...
void scenario(int scNum, network& netw, int T, int i, double Qmax, bool DGplaced)
{
	...
	string fstrname = fname.str();
	ofstream os(fstrname.c_str());
...
int main()
{
  ...
  network netw("input.txt");
	...
	// Neparni cvorovi
	scenario(2, netw, 12, 2, Qmax, DGplaced);
	cout<<"Scenario2 is completed"<<endl;
	scenario(4, netw, 12, 4, Qmax, DGplaced);
	cout<<"Scenario4 is completed"<<endl;
	scenario(6, netw, 12, 6, Qmax, DGplaced);
	cout<<"Scenario6 is completed"<<endl;

	// Parni cvorovi
	scenario(3, netw, 12, 3, Qmax, DGplaced);
	cout<<"Scenario3 is completed"<<endl;
	scenario(5, netw, 12, 5, Qmax, DGplaced);
	cout<<"Scenario5 is completed"<<endl;
	scenario(7, netw, 12, 7, Qmax, DGplaced);
	cout<<"Scenario7 is completed"<<endl;


	scenario(8, netw, 12, 4, 5, Qmax, DGplaced);
	cout<<"Scenario8 is completed"<<endl;
